...
import { enqueueJob, getJobCounts, claimNextJob, completeJob, failJob, STUCK_TIMEOUT_MS } from '../../../server/utils/queue'
...
describe('queue utils', () => {
  beforeEach(() => {
    ...
    const dbSetUpdateMock = vi.fn().mockReturnValue({ where: dbWhereUpdateMock })
